    ...
    while (true)
    {
        ...
        try
        {
            ...
            if (choice == 6)
            {
                ...
                while (true)
                {
                    cout << "Please enter A valid id of the city , the ids of the cities in algeria start from 101 " << endl;
                    cin >> idcity;
                    bool isValid;
            ...
            if (choice == 16)
            {
                cout << "Please Make sure to setup the python environment for Matplotlibcpp, then uncomment the function generateRunningTimeGraph() definition and calland uncomment the include path as well as the namespace definition" << endl;
            ...
            if (choice == 21)
            {
                cout << "Please Make sure to setup the python environment for Matplotlibcpp, then uncomment the function generateSalesBarChart() definition and calland uncomment the include path as well as the namespace definition" << endl;
...
void APMS::runningTimeReportAreas()
{
    ...
    int idCitiesIndex = rand() % idCities.size();
    int areaID = idCities[idCitiesIndex];
    ...
    auto duration = chrono::duration_cast<std::chrono::microseconds>(end - start);
    cout << "The operation took " << duration.count() << "µs" << endl;
}
...
/* void APMS::generateRunningTimeGraph()
{
    ...
    cout << "****************************************************************************" << endl;
    cout << "The generated graph will be stored in an image named avlInsertion.png\n"
         << endl;
    ...
    // setting the label for the x-axis and the label for the y-axis
    plt::xlabel("Input size");
    plt::ylabel("Running Time (microseconds)");
    // Add graph title
    plt::title("The running time for inserting sales in an AVL tree");
    // save figure
    const char *filename = "./avlInsertion.png";
